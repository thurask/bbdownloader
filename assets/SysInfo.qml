    ...
    ScrollView {
        ...
        Container {
            Container {
                ...
                Label {
                    text: qsTr("Boot Time: %1").arg(_manager.readTextFile("/var/boottime.txt", "normal")) + Retranslate.onLanguageChanged;
                }
                Label {
            ...
            Container {
                ...
                Label {
                    text: qsTr("NFC Stack: %1").arg(_manager.readTextFile("/var/etc/nfc/nfcStack.version", "normal")) + Retranslate.onLanguageChanged;
                }
                Label {
                    text: qsTr("WiFi: %1").arg(_manager.readTextFile("/base/etc/wifi.version", "normal")) + Retranslate.onLanguageChanged;
                }
                Label {
                    text: qsTr("Webkit: %1").arg(_manager.readTextFile("/base/etc/webkit.version", "normal")) + Retranslate.onLanguageChanged;
                }
            }
            Container {
                Header {
